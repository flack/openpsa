...
This will create a Midgard database for OpenPSA usage. If this fails or is configured off in your package's
``composer.json``, a new database can be generated by running:
