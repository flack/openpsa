 ...
 * @package openpsa.test
 */
class midcom_admin_user_handler_user_accountTest extends openpsa_testcase
{
    ...
    public function testHandler_delete()
    {
        ...
        $data = $this->run_handler('net.nehmer.static', array('__mfa', 'asgard_midcom.admin.user', 'account', 'delete', self::$_user->guid));
        $this->assertEquals('____mfa-asgard_midcom.admin.user-user_delete_account', $data['handler_id']);
