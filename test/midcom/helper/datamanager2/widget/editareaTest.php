 ...
 * @package openpsa.test
 */
class midcom_helper_datamanager2_widget_editareaTest extends openpsa_testcase
{
    public function test_get_default()
    {
        $dm2_helper = new openpsa_test_dm2_helper;
        $widget = $dm2_helper->get_widget('editarea', 'php');

        $this->assertNull($widget->get_default(), 'nullstorage test failed');

        $dm2_helper->defaults = array('test_editarea_1' => 'TEST');
        $widget = $dm2_helper->get_widget('editarea', 'php');
        ...
        $widget = $dm2_helper->get_widget('editarea', 'php', array('storage' => 'content'));
