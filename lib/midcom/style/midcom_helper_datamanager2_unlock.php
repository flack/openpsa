...
?>
    <div class="midcom_helper_datamanager2_unlock">
        ...
        <p>
            ...
            <?php echo sprintf($this->data['handler']->_l10n->get('lock will expire on %s'), $formatter->datetime(($metadata->get('locked') + (midcom::get()->config->get('metadata_lock_timeout') * 60)))); ?>.
        </p>
<?php
