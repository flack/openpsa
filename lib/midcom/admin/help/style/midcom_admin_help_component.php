...
{
    echo "<h2>" . midcom::get('i18n')->get_string('toc', 'midcom.admin.help') . "</h2>\n";
    ...
    foreach ($data['help_files'] as $file_info)
    {
        ...
        $uri = $_MIDCOM->get_context_data(MIDCOM_CONTEXT_ANCHORPREFIX) . "__ais/help/{$data['component']}/{$uri_parts[0]}/";
