...
function SetXmlHeaders()
{
    ...
    // Date in the past
    _midcom_header('Expires: Mon, 26 Jul 1997 05:00:00 GMT') ;
    // always modified
    _midcom_header('Last-Modified: ' . gmdate('D, d M Y H:i:s') . ' GMT') ;
    // HTTP/1.1
    ...
    _midcom_header( 'Content-Type: text/xml; charset=utf-8' ) ;
}
