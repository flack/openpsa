...
if (!function_exists('mgd_version'))
{
    ...
    {
        return 'none (org.openpsa.mail/nonmidcom.php)';
    }
}


$_SERVER['REMOTE_ADDR'] = 'cli-script: n/a';
require_once(MIDCOM_ROOT . '/org/openpsa/mail/backend/mail.php');
require_once(MIDCOM_ROOT . '/org/openpsa/mail/backend/mail/sendmail.php');
