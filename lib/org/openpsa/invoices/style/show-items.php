...
$grid->set_column('deliverable', $_MIDCOM->i18n->get_string('agreement', 'org.openpsa.projects'), 'width: 80');
$grid->set_column('task', $_MIDCOM->i18n->get_string('task', 'org.openpsa.projects'), 'width: 80');
...
$grid->set_column('quantity', $data['l10n']->get('quantity'), 'align: "right", width: 30, formatter: "number", editable: true');
...
org_openpsa_grid_editable.enable_inline("<?php echo $grid->get_identifier(); ?>",
{
    aftersavefunc: function (rowid, response)
    {
        ...
        {
            total += parseFloat(grid.jqGrid('getCell', rowid, 6));
        }
