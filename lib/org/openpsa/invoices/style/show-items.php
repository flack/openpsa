...
$grid->set_column('deliverable', $_MIDCOM->i18n->get_string('agreement', 'org.openpsa.projects'));
$grid->set_column('task', $_MIDCOM->i18n->get_string('task', 'org.openpsa.projects'));
...
$grid->set_column('actions', '',  'width: 60');
?>
