   ...
   public static function get_instance()
   {
    ...
    private function get_snippet()
    {
        ...
        if (!$lib_snippetdir->guid)
        {
            ...
            if (!$sd->create())
            {
                $_MIDCOM->generate_error(MIDCOM_ERRCRIT,"Failed to create snippetdir {$GLOBALS['midcom_config']['midcom_sgconfig_basedir']}/org.openpsa.core: " . midcom_application::get_error_string());
            }
    ...
    public function create_ui_page()
    {
        ...
        $qb_page = midcom_baseclasses_database_page::new_query_builder();
        ...
        if (count($result) < 1)
        {
            ...
            debug_pop();
            //create page
            $ui_page = new midcom_baseclasses_database_page();
            ...
            $qb_style = midcom_baseclasses_database_style::new_query_builder();
