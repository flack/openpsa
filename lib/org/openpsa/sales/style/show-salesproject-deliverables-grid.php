...
$grid->set_column('title', $data['l10n']->get('title'), 'width: 120, classes: "multiline", editable: true, edittype: "textarea", editoptions: {maxlength: 255}, formatter: viewlink, unformat: extractlabel');
