<div class="main">
    ...
    <form method="post" action="<?php echo midcom_connection::get_url('uri'); ?>" class="datamanager2">
        <label for="org_openpsa_contacts_person_account_username">
            ...
            <input type="text" name="org_openpsa_contacts_person_account_username" id="org_openpsa_contacts_person_account_username" class="shorttext" value="<?php echo $data['account']->get_username(); ?>" />
        </label>
