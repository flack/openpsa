 ...
 * $calendar = new org_openpsa_widgets_calendar_month();
 *
 ...
 * @package org.openpsa.widgets
 */
class org_openpsa_widgets_calendar_month
{
    /**
     ...
     * @var string
     */
    public $css_calendar = 'org_openpsa_widgets_calendar_month';
    ...
    public function __construct()
    {
        ...
        {
            $this->week_text = $_MIDCOM->i18n->get_string('week', 'org.openpsa.widgets');
        }
    ...
    private function _javascript_functions($timestamp)
    {
        ...
        {
            return " onmouseover=\"org_openpsa_widgets_calendar_month_show_box('org_openpsa_widgets_calendar_month_{$timestamp}_{$this->additional_name_for_links}');\" onmouseout=\"org_openpsa_widgets_calendar_month_hide_box('org_openpsa_widgets_calendar_month_{$timestamp}_{$this->additional_name_for_links}');\"";
        }
    }
    ...
    private function _draw_details_box($events, $timestamp)
    {
        ...
        if ($this->use_javascript)
        {
            ...
            $ticker = "<span class=\"{$this->css_close_checker}\" onclick=\"hide_box('org_openpsa_widgets_calendar_month_{$timestamp}_{$this->additional_name_for_links}');\" title=\"Close window\">X</span>";
            $class .= ' hover';
        }
        else
        {
        ...
        echo "                <div id=\"org_openpsa_widgets_calendar_month_{$timestamp}_{$this->additional_name_for_links}\"{$style} class=\"{$class}\">\n";
