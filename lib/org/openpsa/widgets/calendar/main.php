...
class org_openpsa_widgets_calendar extends midcom_baseclasses_components_purecode
{
    ...
    const RESOURCE_PERSON = 6;
    const RESOURCE_ROOM = 7;
    const RESOURCE_CAR = 8;
    const RESOURCE_MISC = 9;

    /**
     * Which calendar are we showing,
     * Use constants like org_openpsa_widgets_calendar::MONTH
     *
     * @var int
     */
    var $type = self::WEEK;
     ...
     *     (
     *         'name'          => 'Henri Bergius',
     *         'resource_type' => org_openpsa_widgets_calendar::RESOURCE_PERSON,
     *         'info_text'     => null,
     *         'css_class'     => 'blue',
     *         'reservations'  => array
     *         (
    ...
    {
        midcom::get('head')->add_stylesheet(MIDCOM_STATIC_URL . "/org.openpsa.widgets/calendarwidget.css");
    }
    ...
    function show()
    {
        echo '<div id="org_openpsa_widgets_calendar">';
        switch ($this->type)
        {
            case self::MONTH:
