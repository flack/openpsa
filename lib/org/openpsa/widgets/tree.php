...
JSINIT;
    ...
    public static function add_head_elements()
    {
        ...
        $head->add_jsfile(MIDCOM_STATIC_URL . '/jQuery/fancytree-2.38.0/jquery.fancytree-all.min.js');
        $head->add_stylesheet(MIDCOM_STATIC_URL . "/stock-icons/font-awesome-4.7.0/css/font-awesome.min.css");
        $head->add_stylesheet(MIDCOM_STATIC_URL . "/jQuery/fancytree-2.38.0/skin-awesome/ui.fancytree.min.css");
