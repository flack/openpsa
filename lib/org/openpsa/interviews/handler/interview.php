    ...
    public function _handler_interview($handler_id, array $args, array &$data)
    {
        ...
        switch ($data['controller']->process_form())
        {
            case 'save':
                ...
                midcom::get()->relocate(midcom_core_context::get()->get_key(MIDCOM_CONTEXT_ANCHORPREFIX) . "next/{$data['campaign']->guid}/");
                // This will exit.
            ...
            case 'cancel':
                ...
                midcom::get()->relocate(midcom_core_context::get()->get_key(MIDCOM_CONTEXT_ANCHORPREFIX) . "campaign/{$data['campaign']->guid}/");
                // This will exit.
        }
    }
