<?php
$url = $data['router']->generate('import_simpleemails', ['guid' => $data['campaign']->guid]);
?>
...
<div class="main">
    ...
    <form enctype="multipart/form-data" action="&(url);" method="post" class="datamanager datamanager2">
