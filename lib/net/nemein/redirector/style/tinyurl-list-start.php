...
<p>
    ...
    <a href="<?php echo midcom_core_context::get()->get_key(MIDCOM_CONTEXT_ANCHORPREFIX); ?>config/" <?php echo $data['workflow']->render_attributes(); ?>><?php echo $data['l10n_midcom']->get('edit'); ?>?</a>
</p>
<table>
    <thead>
        <tr>
