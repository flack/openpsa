 ...
 * @version $Id: publish.php 23975 2009-11-09 05:44:22Z rambo $
        ...
        if (! $attachment)
        {
            ...
            if (! $attachment)
            {
                $_MIDCOM->generate_error(MIDCOM_ERRCRIT,
                    "Failed to create the attachment named {$name}, last Midgard error was: " . midcom_application::get_error_string());
                // This will exit.
            }
        }
